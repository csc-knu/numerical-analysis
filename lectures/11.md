...
\begin{equation}
	\Sum_{j = 1}^n \frac{\partial \vec \varphi}{\partial u_j}(a) \cdot \left(\partial \vec V}{\partial \lambda}(a) + \Sum_{j = 1}^n \frac{\partial \vec \varphi}{\partial u_j}(b) \cdot \left(\partial \vec V}{\partial \lambda}(b) = \vec d - \vec d_0,
\end{equation}
