...
З інтервалів $$\left[ c_1^{(0)}, c_1^{(2)} \right]$$, $$\left[ c_1^{(1)}, c_1^{(2)} \right]$$ (можливо кінці в іншому порядку) вибираємо такий, що $$\varphi \left(b; c_1\right) \right) - d_1$$ змінює знак. Процес продовжуємо до виконання умови
