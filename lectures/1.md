...
>
> \begin{equation}
> \big\| A - \tilde A \big\| < \delta, \big\| f - \tilde f \big\| < \delta \implies \big\| u - \tilde u \big\| < \varepsilon.
> \end{equation}
...
\begin{equation}
	U = \left\{ \vec x = (x_1, \ldots, x_n) : \left| x_i - x_i^\star \right| \le \Delta x_i \right\} \in \Omega,
\end{equation}
