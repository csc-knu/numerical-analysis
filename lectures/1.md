...
\begin{equation}
	U = \left\{ \vec x = (x_1, \ldots, x_n) : \vert x_i - x_i^\star \vert \le \Delta x_i \right\} \in \Omega,
\end{equation}
...
де $$b_i = \left\vert \frac{\partial f}{\partial x_i} (\vec x^\star) \right\vert$$ та &laquo;$$\prec$$&raquo; означає приблизно менше.
...
- Частка $$y = \frac{x_1}{x_2}$$, $$x_1, x_2 > 0$$:
