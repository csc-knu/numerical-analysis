...
_Постановка задачі_. Нехай маємо рівняння $$f(x) = 0$$, $$\overline{x}$$ &mdash; його розв'язок, тобто $$f(\overline{x}) = 0$$.
...
- Березин, Жидков, том.&nbsp;ІІ, стор.&nbsp;135&ndash;140: [djvu](../books/berezin-zhidkov-i-1962.djvu), [pdf](../books/berezin-zhidkov-ii-1962/135-140.pdf).
...
$$
\begin{aligned}
	\vert x_k - \overline{x} \vert &\le q^{2^k - 1} \cdot \vert x_0 - \overline{x} \vert < r, \newline
	\vert \xi_k - \overline{x} \vert &= \vert \theta_k \cdot (x_k - \overline{x}) \vert < r.
\end{aligned}
$$
...
**Зауваження 1:** Якщо $$\overline{x}$$ &mdash; $$p$$-кратний корінь тобто 
