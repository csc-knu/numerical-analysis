...
$$
\vert x_1 - \overline{x} \vert \le \frac{(x_0 - \overline{x})^2 \cdot M_2}{2 m_1} = \frac{M_2 \cdot \vert x_0 - \overline{x} \vert}{2 m_1} \cdot \vert x_0 - \overline{x} \vert = q \cdot \vert x_0 - \overline{x} \vert < r,
$$
...
2. збіжність залежить від початкового наближення $$х_0$$, оскільки від нього залежить умова збіжності $$q = \frac{M_2 \vert x_0 - \overline{x} \vert}{2 m_1} < 1$$;
