...
> **Означення**: Виберемо систему лінійно незалежних функцій $$\{\phi_k(x)\}^n_{k = 0}$$, $$\phi_k(x) \in C([a,b])$$ і побудуємо лінійну комбінацію 
>
> \begin{equation} 
> \label{eq:6.1.1} 
...
> **Означення**: Система функцій $$\{\phi_k (x)\}^n_{k = 0}$$ називається _системою Чебишова_, якщо $$\forall \{x_i\}^n_{i = 0}$$ таких, що $$x_i \in [a,b]$$ і $$x_i \ne x_j$$ при $$i \ne j$$ виконується $$D(x_0, \ldots, x_n)\ne 0$$.
