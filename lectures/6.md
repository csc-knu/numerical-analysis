...
- [6. Інтерполювання функцій](#6-інтерполювання-функцій)
    ...
    - [6.12. Параметричні сплайни: TBC](#612-параметричні-сплайни-tbc)
...
\begin{align}
    ...
    \left(\varphi_i^0\right)'(x_j) &= 0, \newline
    \varphi_i^1(x_j) &= 0, \newline
    \left(\varphi_i^1\right)'(x_j) &= \delta_{i,j}.
\end{align}
...
1. введемо $$\overline \varphi_1^0(s) = \varphi_i^0(x)$$, $$x \in [x_{i - 1}, x_{i + 1}]$$, $$x \in [0,1]$$. Побудуємо цю функцію. Вона задовольняє умовам:
    ...
    \begin{align}
        ...
        \left(\overline \varphi_1^0\right)'(0) &= 0, \newline
        \left(\overline \varphi_1^0\right)'(1) &= 0.
    \end{align}
...
Для того, щоб не розв'язувати СЛАР \eqref{eq:6.11.7} інколи будують наближення до сплайну $$\tilde s(x)$$, яке отримується заміною $$m_i = s^{\prime\prime}(x_i)$$ на
...
> 0 & \frac{1}{h_2} & - \left(\frac{1}{h_2} + \frac{1}{h_3}\right) & \frac{1}{h_3} & \ddots & \ldots \newline
> \vdots & \ddots & \ddots & \ddots & \ddots & \vdots \newline
> 0 & \ldots & 0 & 0 & \frac{1}{h_{n - 1}} & - \left(\frac{1}{h_{n-1}}+\frac{1}{h_n}\right)
> \end{pmatrix}
> \end{equation}
>
