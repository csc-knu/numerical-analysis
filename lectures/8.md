...
- [8. Апроксимування функцій](#8-апроксимування-функцій)
	...
	- [8.5. Системи ортогональних функцій: TBC](#85-системи-ортогональних-функцій-tbc)
...
> **Наслідок**: $$f = \Phi_0 + \nu$$, де $$\Phi_0 \in M_n$$, а $$\nu \perp M_n$$ (поправка $$|nu$$ &mdash; з ортогонального доповнення до $$M_n$$).
...
<a id="85-системи-ортогональних-функцій-tbc"></a>
### 8.5. Системи ортогональних функцій: TBC
