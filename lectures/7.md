...
\begin{equation}
	\label{eq:7.2.1}
	\left| f_i' - \frac{\widetile{f}_i - \widetilde{f}_{i - 1}}{h} \right| \le \left| f_i' - \frac{f_i - f_{i - 1}}{h} \right| + \left| \frac{\delta_i - \delta_{i - 1}}{h} \right| \le \frac{M_2 h}{2} + \frac{2 \delta}{h} \xrightarrow[h \to 0]{} \infty
\end{equation}
$$
