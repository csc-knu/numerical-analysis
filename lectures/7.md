...
\begin{equation}
	\begin{aligned}
		\left| f_i' - \frac{\widetilde{f}_i - \widetilde{f}_{i - 1}}{h} \right| &\le \left| f_i' - \frac{f_i - f_{i - 1}}{h} \right| + \left| \frac{\delta_i - \delta_{i - 1}}{h} \right| \le \label{eq:7.2.1} \newline
...
\begin{equation}
	\begin{aligned}
		& \left| f_i' - \frac{\widetilde{f}_{i + 1} - \widetilde{f}_{i - 1}}{2 h} \right| \le \newline
