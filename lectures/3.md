...
- Березин, Жидков, том&nbsp;II, стор.&nbsp;10&ndash;17: [djvu](../books/berezin-zhidkov-ii-1962.djvu), [pdf](../books/berezin-zhidkov-ii-1962/10-17.pdf).
...
- Березин, Жидков, том&nbsp;II, стор.&nbsp;23&ndash;25: [djvu](../books/berezin-zhidkov-ii-1962.djvu), [pdf](../books/berezin-zhidkov-ii-1962/23-25.pdf).
...
- Березин, Жидков, том&nbsp;II, стор.&nbsp;17&ndash;19: [djvu](../books/berezin-zhidkov-ii-1962.djvu), [pdf](../books/berezin-zhidkov-ii-1962/17-19.pdf).
...
$$A = \text{diag}(\epsilon), \quad a_{i,j} = \epsilon \delta_{i,j}.
$$

Тоді $$\det A = \epsilon^n \ll 1$$, але $$x_i = \frac{b_i}{\epsilon}$$. Тому $$\Delta x_i = \frac{\Delta b_i}{\epsilon} \gg 1$$.
...
$$
\|A\|_1 = \Max_j \Sum_{i=1}^n |a_{i,j}|, \quad \|A\|_2 = \Max_i \sqrt{\lambda_i (A^TA)}, \quad \|A\|_\infty = \Max_i \Sum_{j=1}^n |a_{i,j}|,
$$
...
- $$\cond (A)\ge\frac{\max|\lambda_i(A)|}{\min\vert\lambda_i(A)\vert}$$;

- $$\cond (AB) \le \cond (A) \cdot \cond (B)$$;
	
- $$A^T = A^{-1} \implies \cond (A) = 1$$.
...
$$
H_n = \left(\dfrac{1}{i+j-1}\right)_{i,j=1}^n, \quad \text{наприклад }\cond (H_8)\approx 10^9.
$$
