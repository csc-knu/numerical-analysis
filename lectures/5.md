...
Нехай $$\exists \tilde U$$ &mdash; матриця, така що $$\tilde \Lambda = \tilde U^\intercal A \tilde U$$ і $$\tilde \Lmabda = \left(\tilde \lambda_{ij}\right)^n_{i,j=1}$$, $$\left\vert \tilde \lambda_{ij} \right\vert < \delta \ll 1$$, $$i \ne j$$.
